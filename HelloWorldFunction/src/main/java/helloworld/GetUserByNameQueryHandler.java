 ...
 * FileName    : GetUserByNameQueryHandler
 * Author      : Baekgwa
 * Date        : 26. 2. 11.
 * Description : 
 * =====================================================================================================================
 ...
 */
public class GetUserByNameQueryHandler implements
	...
	public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent input, Context context) {
		...
		try {
			QueryRequest queryRequest = QueryRequest.builder()
				...
				.expressionAttributeValues(Map.of(":nameVal", AttributeValue.builder().s(searchName).build()))
				.build();
			...
			context.getLogger().log("Error querying by name: " + e.getMessage());
			return new APIGatewayProxyResponseEvent()
				.withStatusCode(500)
